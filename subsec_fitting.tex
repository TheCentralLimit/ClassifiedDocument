...
\begin{figure*}[ht]
  \includegraphics[width=\textwidth]{img/line-time.pdf}
  \caption{Visualization of MCMC worker locations over the large number of iterations performed. As you can see, they all converge after around step 2500.}
  \label{fig:MCMC_time}
\end{figure*}
